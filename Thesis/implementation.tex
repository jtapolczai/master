...
\begin{description}
	...
	\begin{description}
		\item[Wumpus.] If there is a Wumpus in a cell $w$ at $\leq 3$ distance from $v$, increase $v$'s stench by $(1 - \log_{10}||v,w||) - \field{stench}(l(v))$.
	  ...
	  * world offers: send gesture
		...
		\item[Pit] If there is a pit in a cell $w$ at a distance $3$ from $v$, set the breeze to 
	\end{description}
