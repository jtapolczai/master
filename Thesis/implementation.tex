...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\figFilter{(-0.75,4)}{$\field{ft}_{\mathsf{A}}$}
		\figFilter{(0.75,4)}{$\field{ft}_{\mathsf{F}}$}
		\figFilter{(2.25,4)}{$\field{ft}_{\mathsf{C}}$}
		\figFilter{(3.75,4)}{$\field{ft}_{\mathsf{E}}$}
		
		TODO: make interpreter command
		TODO: put interpreter & processor next
		TODO: make hormone storage
		TODO: pipe them into hormone storage
		TODO: pipe HS into filters
		TODO: pipe processors into message space
		
	\end{tikzpicture}
	\caption{The PSBC as a collection of a hormone storage and four emotion selectors.}
