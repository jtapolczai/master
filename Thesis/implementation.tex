...
\begin{figure}
	...
	\caption{Sight cone of an agent at $\field{light}(t) = 2$. The agent has a $\frac{\pi}{4}$ field of vision, but cannot see through gaps and around corners.}
	\label{fig:los}
\end{figure}
...
TODO: INCLUDE ROTATION INTO AGENT/WORLD/ACTIONS (ssem)
