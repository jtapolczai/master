	\begin{tikzpicture}
		...
		\figProcessingComponentBentUp{(-0.75,6)}{$\int{A}$}
		\figProcessingComponentBentUp{(0.75,6)}{$\int{F}$}
		\figProcessingComponentBentUp{(2.25,6)}{$\int{C}$}
		\figProcessingComponentBentUp{(3.75,6)}{$\int{E}$}
		...
		\figProcessingComponent{(-0.75,7.5)}{$\fontsize{9.5pt}{1em}\proc{A}$}
		\figProcessingComponent{(0.75,7.5)}{$\fontsize{9.5pt}{1em}\proc{F}$}
		\figProcessingComponent{(2.25,7.5)}{$\fontsize{9.5pt}{1em}\proc{C}$}
		\figProcessingComponent{(3.75,7.5)}{$\fontsize{9.5pt}{1em}\proc{E}$}
