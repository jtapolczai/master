...
\begin{lstlisting}[caption=Actions of the agent in the first seven steps., label=lst:evalWorld5]
   A at (2,0) moved North to (2,1).
   A at (2,1) moved North to (2,2).
